...
SRGAN_LIGHT_CNN_LOSS_MFM4_WEIGHTS_DIR = os.path.join(SRGAN_WEIGHTS_DIR, 'light_cnn_loss_mfm4')
SRGAN_LIGHT_CNN_LOSS_MFM4_GENERATOR_WEIGHTS_DIR = os.path.join(SRGAN_LIGHT_CNN_LOSS_MFM4_WEIGHTS_DIR, 'generator')
SRGAN_LIGHT_CNN_LOSS_MFM4_DISCRIMINATOR_WEIGHTS_DIR = os.path.join(SRGAN_LIGHT_CNN_LOSS_MFM4_WEIGHTS_DIR, 'discriminator')
...
SRGAN_LIGHT_CNN_LOSS_MFM4_LOGS_DIR = os.path.join(SRGAN_LOGS_DIR, 'light_cnn_loss_mfm4')
